 ...
 */
    ...
    function fcb_block_wrapper_classes() {
        $classes    = array();
        $classes[]  = (get_sub_field('cl_block')) ? get_sub_field('cl_block') : '';
        $classes[]  = 'block-wrap';
    ...
    function fcb_block_wrapper_ids() {
        if(get_sub_field('id_block')) 
            $id = get_sub_field('id_block');
        else 
            $id = 'block-' . $GLOBALS['fcb_rows_count'];
        echo $id;
    }
    /**
    ...
    function fcb_block_wrapper_styles() {
        ...
        $top_padding        = (get_sub_field('top_padding')) ? get_sub_field('top_padding') : '140';
        $bottom_padding     = (get_sub_field('bottom_padding')) > -1 ? get_sub_field('bottom_padding') : '40';
        $styles     = array();
        ...
        $styles[]   = 'padding-bottom: '.$bottom_padding.'px;';
